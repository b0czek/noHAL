...
const history: GeneratedCatalogComponentHistory = {
  ...
  variants: [
    ...
    },
    {
      fromVersion: "2.10",
      component: {
        id: "comp:conv-s64-bit:conv-s64-bit",
        name: "conv_s64_bit",
        halComponentName: "conv_s64_bit",
        source: "comp",
        sourcePath: "src/hal/components/conv_s64_bit.comp",
        docs: {
          component: "Convert a value from s64 to bit",
          license: "GPL",
          author: "Jeff Epler",
        },
        pins: [
