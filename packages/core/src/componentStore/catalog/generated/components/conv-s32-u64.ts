...
const history: GeneratedCatalogComponentHistory = {
  ...
  variants: [
    ...
    },
    {
      fromVersion: "2.10",
      component: {
        id: "comp:conv-s32-u64:conv-s32-u64",
        name: "conv_s32_u64",
        halComponentName: "conv_s32_u64",
        source: "comp",
        sourcePath: "src/hal/components/conv_s32_u64.comp",
        docs: {
          component: "Convert a value from s32 to u64",
          license: "GPL",
          author: "Jeff Epler",
        },
        pins: [
