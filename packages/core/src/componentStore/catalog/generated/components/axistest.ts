...
const history: GeneratedCatalogComponentHistory = {
  halComponentName: "axistest",
  variants: [
    {
      fromVersion: "2.7",
      component: {
        id: "comp:axistest:axistest",
        name: "axistest",
        halComponentName: "axistest",
        source: "comp",
        sourcePath: "src/hal/components/axistest.comp",
        docs: {
        ...
        pins: [
          {
            ...
            name: "jog-minus",
            type: "bit",
            doc: "Drive TRUE to jog the axis in its negative ('minus') direction.",
            direction: "in",
          },
          {
            key: "jog_plus",
