...
const history: GeneratedCatalogComponentHistory = {
  ...
  variants: [
    ...
    },
    {
      fromVersion: "2.10",
      component: {
        id: "comp:conv-u64-u32:conv-u64-u32",
        name: "conv_u64_u32",
        halComponentName: "conv_u64_u32",
        source: "comp",
        sourcePath: "src/hal/components/conv_u64_u32.comp",
        docs: {
          component: "Convert a value from u64 to u32",
          license: "GPL",
          author: "Jeff Epler",
        },
        pins: [
