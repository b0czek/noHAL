...
const history: GeneratedCatalogComponentHistory = {
  ...
  variants: [
    ...
    },
    {
      fromVersion: "2.10",
      component: {
        id: "comp:conv-s64-u64:conv-s64-u64",
        name: "conv_s64_u64",
        halComponentName: "conv_s64_u64",
        source: "comp",
        sourcePath: "src/hal/components/conv_s64_u64.comp",
        docs: {
          component: "Convert a value from s64 to u64",
          license: "GPL",
          author: "Jeff Epler",
        },
        pins: [
