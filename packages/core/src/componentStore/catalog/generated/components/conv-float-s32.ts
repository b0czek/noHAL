...
const history: GeneratedCatalogComponentHistory = {
  halComponentName: "conv_float_s32",
  variants: [
    {
      fromVersion: "2.7",
      component: {
        id: "comp:conv-float-s32:conv-float-s32",
        name: "conv_float_s32",
        halComponentName: "conv_float_s32",
        source: "comp",
        sourcePath: "src/hal/components/conv_float_s32.comp",
        docs: {
          component: "Convert a value from float to s32",
          license: "GPL",
        },
        pins: [
          {
