...
const history: GeneratedCatalogComponentHistory = {
  ...
  variants: [
    ...
    },
    {
      fromVersion: "2.10",
      component: {
        id: "comp:conv-s64-u32:conv-s64-u32",
        name: "conv_s64_u32",
        halComponentName: "conv_s64_u32",
        source: "comp",
        sourcePath: "src/hal/components/conv_s64_u32.comp",
        docs: {
          component: "Convert a value from s64 to u32",
          license: "GPL",
          author: "Jeff Epler",
        },
        pins: [
