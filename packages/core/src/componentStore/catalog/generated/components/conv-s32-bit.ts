...
const history: GeneratedCatalogComponentHistory = {
  halComponentName: "conv_s32_bit",
  variants: [
    {
      fromVersion: "2.7",
      component: {
        id: "comp:conv-s32-bit:conv-s32-bit",
        name: "conv_s32_bit",
        halComponentName: "conv_s32_bit",
        source: "comp",
        sourcePath: "src/hal/components/conv_s32_bit.comp",
        docs: {
          component: "Convert a value from s32 to bit",
          license: "GPL",
        },
        pins: [
          {
