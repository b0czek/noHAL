...
const history: GeneratedCatalogComponentHistory = {
  ...
  variants: [
    ...
    },
    {
      fromVersion: "2.10",
      component: {
        id: "comp:conv-u32-s64:conv-u32-s64",
        name: "conv_u32_s64",
        halComponentName: "conv_u32_s64",
        source: "comp",
        sourcePath: "src/hal/components/conv_u32_s64.comp",
        docs: {
          component: "Convert a value from u32 to s64",
          license: "GPL",
          author: "Jeff Epler",
        },
        pins: [
