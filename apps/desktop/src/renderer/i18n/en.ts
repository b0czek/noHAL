export const en = {
  ...
  "componentSearch.placeholder": "Search for items in {scope}...",
  "componentSearch.resultsCount": "{count} match(es)",
  "componentSearch.sheetMeta": "Sheet: {sheet}",
  "componentSearch.resultMeta": "{kind} • Sheet: {sheet}",
  "componentSearch.kind.component": "Component",
  "componentSearch.kind.subsheet": "Subsheet",
  "componentSearch.kind.label": "Label",
  "componentSearch.kind.port": "Port",
  "componentSearch.kind.comment": "Text",
  "componentSearch.noResults": "No matching items.",
  ...
  "componentStore.noSources": "No manual component sources yet.",
  "componentStore.storedComponents": "Components",
  "componentStore.browseVersion": "Browse version",
  "componentStore.projectVersion": "Project uses {version}",
